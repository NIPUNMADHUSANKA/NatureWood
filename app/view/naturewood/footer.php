...
<footer>
    ...
    <script type="text/javascript" src="<?=ASSETS?>naturewood/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>naturewood/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>naturewood/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>naturewood/js/template-scripts.js"></script> 
  </body>
</html>